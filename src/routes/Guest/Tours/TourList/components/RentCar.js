...
class RentCar extends Component {
  ...
  getTitle = () => {
    switch (this.props.params.id){
      case 'nam' : return ( <Helmet>
        <title>Thuê xe theo năm-Thuê xe TTB</title>
      </Helmet>);
      case 'quy' : return ( <Helmet>
        <title>Thuê xe theo quý-Thuê xe TTB</title>
      </Helmet>);
      case 'thang' : return ( <Helmet>
        <title>Thuê xe theo tháng-Thuê xe TTB</title>
      </Helmet>);
      case 'theo-tuyen' : return ( <Helmet>
        <title>Thuê xe theo tuyến-Thuê xe TTB</title>
      </Helmet>);
  ...
  handleBanner = () => {
    ...
    switch (this.props.params.id){
      case 'nam' : return settings.bannerRentCars;
      case 'thang' : return settings.bannerRentCars;
      case 'quy' : return settings.bannerRentCars;
      case 'theo-tuyen' : return settings.bannerRentCarsRoute;
