...
export default class listSaleOrderView extends Component {
    ...
    deleteEmpl = (empl) => {
        swal({
            ...
            ,
            text : `Xóa đơn hàng ${empl.proposalID}`
        }).then(value=>{
            console.log(value)
            if(value){
                    ...
                    <div className='card'>
                        <ReactTable
                            columns={[
                                ...
                                {
                                    Header : 'Địa chỉ',
                                    accessor: 'SaleOrderDeliveryAddress',
                                },
                                {
