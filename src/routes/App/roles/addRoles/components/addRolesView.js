...
export default class addRolesView extends Component {
    ...
    submitForm  = (e) => {
        ...
        formData.idRole = this.guidGenerator()
        this.props.addRoles(formData)
                            ...
                            <div className='row'>
                                ...
                                <div className='col-sm-12'>
                                    ...
                                    <div className="form-group icheckbox_flat-red">
                                        <Checkbox name="status" label="Hoạt động" defaultChecked={false} className='radio'/>
                                    </div>
                                </div>
                                <div className='col-sm-12'>
